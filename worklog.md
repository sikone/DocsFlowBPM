...
уведомление о просроченном задании за час до просрочки - проверить в понедельник
...
Добавить кнопку обновления для документа
#Синхронизация с AD - готово
Довести до ума фильтры логирования. Там какая то хуйня сейчас.
