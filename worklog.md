...
#Отчётность по каждому сотруднику.  - готово
#Финальное подписание документа, в электронном виде или на бумаге - не формируется pdf, openoffice - готово
#Сделать шаблоны e-mail - готово
#Сделать правила маршрутизации между папка индивидуально для каждого пользователя, конструктр правил. - работает
==============================================
todo:

Статус "подписан ЭЦП" только к тем документам которые реально подписаны ЭЦП
Сделать кнопку "сделать версию файла основной"
Сделать сравнение версий файла - допилить
Добавить уведомление сотрудника и руководителя о проёбе SLA - проверить
#Кнопка обновить документ не полностью обновляет - проверить
Категория файлов (черновик, согласованый, подпсианный) - частично
#Продумать календарь, праздничные дни, не рабочие дни - проверить
Сделать папку "завершённые" - да сами пользователи сделают если захотят
Внедрить OCR к документам
Сделать шаг бизнес процесса "согласование руководителем" - согласовывает руководитель инициатора.
#Шаг бизнес процесса, отправить емейл - проверить
Перемещение в архив документов старше 1 года, настройка
Полнотекстовый поиск по приложенных документам - ?
