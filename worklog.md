...
todo:
Редактирование карточки пользователем без прав, баг
разобраться с папками и уведомлениями
Подсвечивать срочные не срочные документы и подсвечивать просроченные задания
уведомление о просроченном задании за час до просрочки
Делать word из шаблона
Финальное подписание документа, в электронном виде или на бумаге
Посмотреть что там по редактированию документа, автоматически завершать редактирование при закрытии
Заполнение контрагента по ИНН автоматически
Роут согласования в зависимости от типа или галочки в документе.
Добавление контрагентов контактов обычным пользователям по клику на поле.
Уведомление в почту с приложеным документом (не приоритетно)
Прикрутить АИ ассистента (не приоритетно)
Сверка документов АИ ассистентом
